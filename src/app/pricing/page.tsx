      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
            Choose Your
            <span className="text-primary-400 block">Maritime Plan</span>
          </h1>
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-secondary-300 text-sm mb-4">{tier.description}</p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-secondary-300">AI Agents</span>
                  <span className="text-white font-semibold">{tier.agents}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-secondary-300">Requests per agent</span>
                  <span className="text-white font-semibold">{tier.requestsPerAgent.toLocaleString()}/month</span>
                </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="text-left">
              <h3 className="text-lg font-semibold text-white mb-2">What happens if I exceed my request limit?</h3>
            ...
            <div className="text-left">
              <h3 className="text-lg font-semibold text-white mb-2">Do you offer custom enterprise plans?</h3>
              <p className="text-secondary-300 text-sm">
        ...
        <div className="text-center mt-16 p-8 bg-white/5 rounded-2xl border border-white/10">
          <h2 className="text-2xl font-bold text-white mb-4">Ready to Set Sail?</h2>
          <p className="text-secondary-300 mb-6">
            Join thousands of businesses already using CrewFlow to automate their operations.
          </p>
          <Link
            href="/auth/signup"
            className="bg-primary-500 hover:bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors inline-flex items-center space-x-2"
          >
