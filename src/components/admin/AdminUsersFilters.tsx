      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-sm bg-secondary-700 border border-secondary-600 rounded-lg text-white focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
          >
      ...
      {Object.values(filters).some(value => value !== 'all' && value !== '30d') && (
        <div className="mt-4 pt-4 border-t border-secondary-700">
          <div className="flex items-center space-x-2 flex-wrap">
            <span className="text-xs text-secondary-400">Active filters:</span>
            {filters.role !== 'all' && (
              <span className="px-2 py-1 text-xs bg-primary-900/20 text-primary-400 rounded border border-primary-900/30">
                Role: {filters.role}
              </span>
            )}
