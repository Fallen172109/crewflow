...
import { Package, AlertTriangle, Truck, ShoppingCart, Send, Loader2, BarChart3, TrendingUp } from 'lucide-react'
...
export default function AnchorAgent({ userId }: AnchorAgentProps) {
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white p-6 rounded-lg">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Anchor - Supply Chain/Inventory</h1>
            <p className="text-emerald-100">Your triple-hybrid AI supply chain specialist</p>
          </div>
        </div>
      </div>
      ...
      {/* Preset Actions */}
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Supply Chain Actions</h2>
            ...
            return (
              <button
                ...
                className={`p-4 rounded-lg border-2 text-left hover:shadow-md transition-all duration-200 disabled:opacity-50 ${getCategoryColor(action.category)} ${
                  activeAction === action.id ? 'ring-2 ring-emerald-500' : ''
                }`}
              >
        ...
        <div className="space-y-4">
          <div className="flex space-x-2">
            <input
              ...
              placeholder="Ask about inventory tracking, supplier monitoring, or supply chain optimization..."
